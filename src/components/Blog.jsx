...
import tvposter from "./images/TV Poster.jpg"
import "./blog.css";
...
const Blog = () => {
    ...
    const blogs = [
        ...
        {
            id: 5,
            title: "Experience Brilliance: The Red Wolf Smart LED TV Revolution",
            desc: "In the era of smart entertainment, your TV deserves to do more than just display — it should immerse. That’s exactly what Red Wolf Smart LED TVs deliver — a seamless fusion of cutting-edge technology, lifelike visuals, and powerful sound designed to elevate every moment you watch.",
            img: tvposter,
            full: "With built-in apps like Hotstar, Hungama, and SonyLIV, your entertainment is just a click away. Whether it’s binge-worthy shows, blockbuster movies, or live sports, Red Wolf Smart TVs bring the world of entertainment straight to your living room. Unmatched Picture & Sound Every scene shines in stunning HD clarity, powered by Red Wolf’s advanced display technology. The 20W stereo speakers create a theatre-like experience right at home — crisp, clear, and truly immersive. Performance Meets Design Sleek, modern, and built for today’s homes, Red Wolf TVs are as stylish as they are powerful. With multiple connectivity ports, dual USB slots, and smooth interface navigation, you get flexibility and speed in one frame. Why Choose Red Wolf Smart LED TV? Because it’s not just a screen — it’s a gateway to limitless entertainment. Engineered for performance, crafted for durability, and designed to inspire, Red Wolf LED TVs redefine how you experience digital content. Step into the future of home entertainment. Visit www.redwolfinfotech.com to explore the full range of Red Wolf Smart LED TVs."
        }
    ];
